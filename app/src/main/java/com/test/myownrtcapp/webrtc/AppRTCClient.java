...
public interface AppRTCClient {
  ...
  interface SignalingEvents {
    ...
    void onConnectedToRoom(final SignalingParameters params, final Socket clientSocketIO, final JSONObject jsonObject);
    ...
    void onRemoteDescription(final SessionDescription sdp,final Socket socket);
